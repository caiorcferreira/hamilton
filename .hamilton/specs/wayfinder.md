...
- A ticket's resolving skill MUST be loaded before resolution work begins. A prototype ticket MUST NEVER produce prototype code before `hamilton-wayfinder-prototype` is loaded and its branch gate has run.
