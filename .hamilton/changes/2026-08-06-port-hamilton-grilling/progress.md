...
- Review: approved — protocol text byte-identical to upstream; frontmatter correct; provenance pointer properly formatted with em dash; caller-agnostic boundary maintained; `agents/openai.yaml` not ported.
